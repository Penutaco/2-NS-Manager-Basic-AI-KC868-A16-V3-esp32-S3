...
CONFIG = {
    ...
    "serial_port": "/dev/ttyUSB1",  # Updated from /dev/ttyUSB0 to /dev/ttyUSB1
    ...
    "stage_1_trigger_hours": 0.0,
    "stage_1_target_ph": 4.0,
    "stage_1_ph_tolerance": 0.2,
    "stage_1_target_ec": 0.5,
    "stage_1_ec_tolerance": 0.1,
    "stage_1_ec_continuous_monitoring": True,
    "stage_1_ratio_sol_a_b_c": [1.0, 1.0, 1.0],
    
    # Stage 2 Configuration
    "stage_2_enabled": True,
    "stage_2_trigger_hours": 1.0,
    ...
    "stage_2_ratio_sol_a_b_c": [1.0, 0.0, 0.0],
    
    # Stage 3 Configuration
    "stage_3_enabled": True,
    "stage_3_trigger_hours": 3.0,
    ...
    "stage_14_ratio_sol_a_b_c": [1.0, 1.0, 1.0],
}
        ...
        while self.running:
            try:
                ...
                if measurement_result:
                    ...
                    # Check minimum cycle
                    if int(cycle_id) < 2:
                        logger.info(f"Skipping cycle {cycle_id} - minimum cycle is 2")
                        time.sleep(1)
                        continue
