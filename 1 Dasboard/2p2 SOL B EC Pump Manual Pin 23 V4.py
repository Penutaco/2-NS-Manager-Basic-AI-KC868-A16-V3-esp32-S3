#!/usr/bin/env python3
"""
Test script for EC pump on pin 25 with user-defined duration - with dashboard logging
"""
import serial
import time
import sys
...
simplified_log = f"Manual Dosing: EC+ SolB on pin 23 for {duration_ms}ms"
...
try:
    ...
    # Now communicate with ESP32 directly
    # with serial.Serial("/dev/cu.usbserial-110", 115200, timeout=1) as ser:
        # Clear any pending data
        # ser.reset_input_buffer()
        
        # Send JSON command for EC pump with user-defined duration
        # cmd = f'{{"action":"dose","pin":25,"duration_ms":{duration_ms},"pump_type":"ec_plus"}}\n'.encode()
        # ser.write(cmd)
...
# except serial.SerialException as e:
    ...
    # try:
        # if 'ser' in locals() and ser.is_open:
            # ser.write(b'{"action":"stop","pin":25}\n')
