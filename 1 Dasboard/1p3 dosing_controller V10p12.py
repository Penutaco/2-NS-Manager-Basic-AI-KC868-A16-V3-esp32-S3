...
CONFIG = {
    "tank_volume_liters": 15.0,            # Tank volume in liters
    ...
    "max_dosing_time_ms": 60000,           # Maximum dosing time in milliseconds
    ...
    "ph_plus_pin": 27,                    # GPIO pin for pH+ dosing pump
    "ph_minus_pin": 26,                   # GPIO pin for pH- dosing pump
    "ec_plus_sola_pin": 25,               # GPIO pin for EC+ SolA dosing pump
    "ec_plus_solb_pin": 23,               # GPIO pin for EC+ SolB dosing pump
    "ec_plus_solc_pin": 33,               # GPIO pin for EC+ SolC dosing pump
    "ec_minus_h2o_pin": 19,               # GPIO pin for EC- H2O dosing pump
    "data_dir": os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data'),
    "serial_port": "/dev/cu.usbserial-13120",  # Updated ESP32 USB port for macOS
    "serial_baudrate": 115200,               # Baudrate para comunicação serial
    "zmq_timeout_ms": 20000,                  # Timeout para comunicação ZMQ em milissegundos
    ...
    "ec_h2o_dilution_coefficient": 1.0,      # mL of H2O per L of tank volume per 1.0 mS/cm decrease (start at 0)
    ...
    "initial_safety_factor": 1,            # Initial 100% safety factor for first dosing
    "flow_calibration_factor": 1.0,           # Adjustment factor for pump calibration
    
    # NEW: 14-Stage System Configuration
    "program_start_time": None,               # Set when program starts
    "current_stage": 1,                       # Current active stage (1-14)
    
    # Stage 1 Configuration
    "stage_1_enabled": True,
    "stage_1_trigger_hours": 48.0,
    "stage_1_target_ph": 6.0,
    "stage_1_ph_tolerance": 0.2,
    "stage_1_target_ec": 1.7,
    "stage_1_ec_tolerance": 0.1,
    "stage_1_ec_continuous_monitoring": True,
    "stage_1_ratio_sol_a_b_c": [1.0, 1.0, 0.0],
    
    # Stage 2 Configuration
    "stage_2_enabled": False,
    "stage_2_trigger_hours": 2.0,
    "stage_2_target_ph": 5.0,
    "stage_2_ph_tolerance": 0.2,
    "stage_2_target_ec": 0.6,
    "stage_2_ec_tolerance": 0.1,
    "stage_2_ec_continuous_monitoring": True,
    "stage_2_ratio_sol_a_b_c": [1.0, 1.0, 1.0],
    
    # Stage 3 Configuration
    "stage_3_enabled": False,
    "stage_3_trigger_hours": 4.0,
    "stage_3_target_ph": 6.0,
    "stage_3_ph_tolerance": 0.2,
    "stage_3_target_ec": 0.7,
    "stage_3_ec_tolerance": 0.1,
    "stage_3_ec_continuous_monitoring": True,
    "stage_3_ratio_sol_a_b_c": [1.0, 1.0, 1.0],
    
    # Stage 4 Configuration
    "stage_4_enabled": False,
    "stage_4_trigger_hours": 6.0,
    "stage_4_target_ph": 7.0,
    "stage_4_ph_tolerance": 0.2,
    "stage_4_target_ec": 0.8,
    "stage_4_ec_tolerance": 0.1,
    "stage_4_ec_continuous_monitoring": True,
    "stage_4_ratio_sol_a_b_c": [1.0, 1.0, 1.0],
    
    # Stage 5 Configuration
    "stage_5_enabled": True,
    "stage_5_trigger_hours": 8.0,
    "stage_5_target_ph": 6.0,
    "stage_5_ph_tolerance": 0.2,
    "stage_5_target_ec": 0.9,
    "stage_5_ec_tolerance": 0.1,
    "stage_5_ec_continuous_monitoring": True,
    "stage_5_ratio_sol_a_b_c": [1.0, 1.0, 0.0],
    
    # Stage 6 Configuration
    "stage_6_enabled": True,
    "stage_6_trigger_hours": 10.0,
    "stage_6_target_ph": 5.0,
    "stage_6_ph_tolerance": 0.2,
    "stage_6_target_ec": 1.0,
    "stage_6_ec_tolerance": 0.1,
    "stage_6_ec_continuous_monitoring": True,
    "stage_6_ratio_sol_a_b_c": [1.0, 1.0, 0.0],
    
    # Stage 7 Configuration
    "stage_7_enabled": False,
    "stage_7_trigger_hours": 12.0,
    "stage_7_target_ph": 4.0,
    "stage_7_ph_tolerance": 0.2,
    "stage_7_target_ec": 1.1,
    "stage_7_ec_tolerance": 0.1,
    "stage_7_ec_continuous_monitoring": True,
    "stage_7_ratio_sol_a_b_c": [1.0, 1.0, 0.0],

    # Stage 8 Configuration
    "stage_8_enabled": False,
    "stage_8_trigger_hours": 14.0,
    "stage_8_target_ph": 5.0,
    "stage_8_ph_tolerance": 0.2,
    "stage_8_target_ec": 1.0,
    "stage_8_ec_tolerance": 0.1,
    "stage_8_ec_continuous_monitoring": True,
    "stage_8_ratio_sol_a_b_c": [1.0, 0.0, 0.0],
    
    # Stage 9 Configuration
    "stage_9_enabled": False,
    "stage_9_trigger_hours": 16.0,
    "stage_9_target_ph": 6.0,
    "stage_9_ph_tolerance": 0.2,
    "stage_9_target_ec": 1.0,
    "stage_9_ec_tolerance": 0.1,
    "stage_9_ec_continuous_monitoring": False,
    "stage_9_ratio_sol_a_b_c": [1.0, 0.0, 0.0],
    
    # Stage 10 Configuration
    "stage_10_enabled": False,
    "stage_10_trigger_hours": 18.0,
    "stage_10_target_ph": 5.0,
    "stage_10_ph_tolerance": 0.2,
    "stage_10_target_ec": 1.0,
    "stage_10_ec_tolerance": 0.1,
    "stage_10_ec_continuous_monitoring": False,
    "stage_10_ratio_sol_a_b_c": [1.0, 0.0, 1.0],
    
    # Stage 11 Configuration
    "stage_11_enabled": False,
    "stage_11_trigger_hours": 20.0,
    "stage_11_target_ph": 4.0,
    "stage_11_ph_tolerance": 0.2,
    "stage_11_target_ec": 1.0,
    "stage_11_ec_tolerance": 0.1,
    "stage_11_ec_continuous_monitoring": False,
    "stage_11_ratio_sol_a_b_c": [1.0, 0.0, 1.0],
    
    # Stage 12 Configuration
    "stage_12_enabled": True,
    "stage_12_trigger_hours": 22.0,
    "stage_12_target_ph": 5.0,
    "stage_12_ph_tolerance": 0.2,
    "stage_12_target_ec": 1.0,
    "stage_12_ec_tolerance": 0.1,
    "stage_12_ec_continuous_monitoring": False,
    "stage_12_ratio_sol_a_b_c": [1.0, 0.0, 1.0],
    
    # Stage 13 Configuration
    "stage_13_enabled": False,
    "stage_13_trigger_hours": 24.0,
    "stage_13_target_ph": 6.0,
    "stage_13_ph_tolerance": 0.2,
    "stage_13_target_ec": 1.0,
    "stage_13_ec_tolerance": 0.1,
    "stage_13_ec_continuous_monitoring": False,
    "stage_13_ratio_sol_a_b_c": [1.0, 0.0, 1.0],
    
    # Stage 14 Configuration
    "stage_14_enabled": False,
    "stage_14_trigger_hours": 26.0,
    "stage_14_target_ph": 6.2,
    "stage_14_ph_tolerance": 0.2,
    "stage_14_target_ec": 1.0,
    "stage_14_ec_tolerance": 0.1,
    "stage_14_ec_continuous_monitoring": False,
    "stage_14_ratio_sol_a_b_c": [1.0, 0.0, 1.0],
}

# Criar diretório data se não existir (já deve existir, mas por segurança)
os.makedirs(CONFIG["data_dir"], exist_ok=True)

# Variáveis para rotação de logs
current_log_time = datetime.now().strftime("%Y%m%d_%H%M%S")
current_log_file = os.path.join(CONFIG["data_dir"], f'dosing_controller_{current_log_time}.log')

# Configurar logging com nível DEBUG para o arquivo (mas INFO para console)
logging.basicConfig(
    level=logging.INFO,
    handlers=[
...
# Ajustar níveis de logging para ser mais econômico
for handler in logging.getLogger().handlers:
    handler.setFormatter(formatter)
    # Configurar apenas o FileHandler para usar INFO
    if isinstance(handler, logging.FileHandler):
        handler.setLevel(logging.INFO) # << GARANTIR QUE ESTEJA INFO (SE ANTES ESTAVA DEBUG

# Configurar logger para mensagens de debug
logger = logging.getLogger("DosingController")

# Thread para rotação de logs
def rotate_log_files():
    global current_log_file
    while True:
        time.sleep(3600)  # A cada hora
        # Criar novo arquivo de log com timestamp atual
        for handler in logging.getLogger().handlers:
            if isinstance(handler, logging.FileHandler):
                handler.close()
        ...
        file_handler.setLevel(logging.INFO)  # << JÁ ESTÁ INFO, CORRETO E CONSISTENTE
        logging.getLogger().addHandler(file_handler)
        
        # Adicionar handler de console novamente
        console_handler = logging.StreamHandler()
        console_handler.setFormatter(formatter)
        console_handler.setLevel(logging.INFO)  # << JÁ ESTÁ INFO, CORRETO
        logging.getLogger().addHandler(console_handler)
        
        logger.info(f"Log file rotated to: {current_log_file}")

# Iniciar thread de rotação de logs
threading.Thread(target=rotate_log_files, daemon=True).start()
...
class DosingController:
    def __init__(self, config=CONFIG):
        ...
        # Initialize program start time when controller is created
        if self.config["program_start_time"] is None:
            self.config["program_start_time"] = time.time()
            logger.info(f"Program started at: {datetime.fromtimestamp(self.config['program_start_time']).strftime('%Y-%m-%d %H:%M:%S')}")
            logger.info(f"14-Stage System initialized - Starting at Stage {self.config['current_stage']}")
        ...
        self.ec_h2o_dilution_coefficient = self.config.get('ec_h2o_dilution_coefficient', 0.0)
        ...
        if self.current_event_file: # ADICIONADO
            logger.info(f"Initially using event file: {self.current_event_file}") # ADICIONADO
        else: # ADICIONADO
            logger.warning("No event file found at startup.") # ADICIONADO

    def check_for_new_event_file(self): # NOVA FUNÇÃO ADICIONADA
        """Check for new event data files and switch if needed."""
        try:
            new_event_file_path = self.find_latest_event_file()
            if new_event_file_path:
                new_event_file_str = str(new_event_file_path)
                current_event_file_str = str(self.current_event_file) if self.current_event_file else ""

                if new_event_file_str != current_event_file_str:
                    logger.info(f"New event data file detected: {new_event_file_str}. Switching from {current_event_file_str}")
                    self.current_event_file = new_event_file_path
                    self.last_event_read_position = 0  # Resetar o ponteiro de leitura para o novo ficheiro
                    # Opcional: Limpar o buffer de eventos, pois os eventos antigos podem não ser relevantes para o novo ficheiro.
                    # self.event_buffer.clear()
                    # logger.info("Event buffer cleared due to new event file.")
                    return True
            return False
        except Exception as e:
            logger.error(f"Error checking for new event file: {e}")
            return False
    ...
    def setup_communication(self):
        ...
        try:
            ...
            self.dashboard_socket.setsockopt(zmq.LINGER, 0)
        ...
        try:
            ...
            if len(parts) >= 8:  # Check if we have enough columns
                ...
                if all(x is not None for x in [time_ms, ec_v, ec_mScm, ph_v, ph_val]):
                    ...
                    # logger.debug(f"Sensor data processed: pH={ph_val:.2f}, EC={ec_mScm:.2f} mS/cm") # V8p4 LOGA ISTO COMO INFO MAIS TARDE, APÓS DETECTAR EVENTO
                    # No V8p4, o log equivalente é "Current sensor readings: pH=..." que já existe no run()
        except Exception as e:
                ...
                for line in content.split('\n'):
                    ...
                    if len(parts) >= 10:
                        ...
                        if (event_type == "PRGSample" and 
                            ...
                            try:
                                cycle_id = parts[0].strip()
                                ph_val = float(parts[9])
                                ec_val = float(parts[7])
                                ...
                                logger.info(f"Event #5 detected (cycle {cycle_id}). Resetting event file pointer to {position_before_reading} for Event #6 re-scan.")
                                
                                return measurement_type, cycle_id
                            except (ValueError, IndexError) as e:
                                logger.error(f"Error parsing sensor values: {e}")
                    
                return None # Se o loop terminar sem encontrar o evento #5
        except Exception as e:
    ...
    def is_event_already_processed(self, cycle_id, event_id=None):
        ...
        if event_id and event_id in self.event_unique_ids:
            if self.event_unique_ids[event_id].get('processed', False):
                # logger.debug(f"Evento com ID único {event_id} já foi processado anteriormente") # Comentado, V8p4 não tem
                return True
        ...
        if cycle_id in self.processed_events:
            ...
            if now - last_processed < 600:  # 10 minutos em segundos
                # logger.debug(f"Evento para ciclo {cycle_id} já foi processado em {datetime.fromtimestamp(last_processed).strftime('%H:%M:%S')}")
                return True
    ...
    def check_solution_transition(self):
        ...
        logger.info(f"EC depletion rate change: {rate_change:.2f}, Threshold: {self.config['solution_a_to_b_threshold']}") # Comentar, V8p4 não tem
    ...
    def update_titration_coefficients(self):
        ...
        if (self.last_cycle_id is None or self.last_cycle_dosing is None or
            ...
            logger.info("No previous cycle data available for coefficient learning") # Comentar, V8p4 não tem este log INFO
            return
        ...
        elif pump_type.startswith("ec_plus") or pump_type == "multi_ec_plus":
            # Update EC+ coefficient (shared by all EC+ pumps)
        ...
        elif pump_type == "ec_minus_h2o":
            observed_change = abs(self.last_cycle_ec_value - current_ec)  # EC decrease
            logger.info(f"Observed EC decrease: {observed_change:.3f} mS/cm from {volume_dosed:.2f}mL H2O")
    
            if observed_change >= 0.01:
                ml_per_l_per_ec = volume_dosed / (observed_change * self.config['tank_volume_liters'])
                learning_rate = 0.5
                current_coefficient = self.ec_h2o_dilution_coefficient
                new_coefficient = current_coefficient * (1 - learning_rate) + (ml_per_l_per_ec * learning_rate)
                self.ec_h2o_dilution_coefficient = new_coefficient
                self.config['ec_h2o_dilution_coefficient'] = new_coefficient
                logger.info(f"Updated H2O Dilution Coefficient: {current_coefficient:.2f} → {new_coefficient:.2f}")
    ...
    def convert_volume_to_dosing_time(self, volume_ml):
        ...
        # logger.debug(f"Converted {volume_ml:.2f} mL to {dosing_time_ms} ms dosing time (flow rate: {self.config['pump_flow_rate']:.1f} mL/min)")
        # Mudar para logger.info para espelhar V8p4
    ...
    def chemistry_based_dosing_decision(self, measurement_type):
        """Make dosing decisions based on chemical calculations with stage-based targets"""
        ...
        if not stage_config:
            logger.warning("No stage configuration available")
            return None
        ...
        # Use stage-specific targets and tolerances
        target_ph = stage_config["target_ph"]
        ph_tolerance = stage_config["ph_tolerance"]
        target_ec = stage_config["target_ec"]
        ec_tolerance = stage_config["ec_tolerance"]
        ec_continuous_monitoring = stage_config["ec_continuous_monitoring"]
        
        # Calculate deviations using stage targets
        ph_deviation = abs(ph_val - target_ph)
        ec_deviation = abs(ec_mScm - target_ec)
        
        logger.info(f"Stage {stage_config['stage_number']} analysis - pH: {ph_val:.2f} (target: {target_ph}, deviation: {ph_deviation:.2f}), EC: {ec_mScm:.2f} mS/cm (target: {target_ec}, deviation: {ec_deviation:.2f})")
        
        # First priority: Check if EC needs correction (only if continuous monitoring is enabled)
        if ec_continuous_monitoring and ec_deviation > ec_tolerance:
            if ec_mScm > target_ec:
                # EC too high - use H2O dilution
                ec_excess = ec_mScm - target_ec
                # Fórmula CORRETA com aprendizagem adaptativa:
                theoretical_volume = self.config['tank_volume_liters'] * 1000 * (ec_excess / target_ec)
                volume_needed = theoretical_volume * self.ec_h2o_dilution_coefficient
                
                # Apply safety factor for H2O
                h2o_dosing_count = len([e for e in self.dosing_history if e.get('pump') == 'ec_minus_h2o'])
                if h2o_dosing_count == 0:
                    volume_needed /= 10
                    logger.info(f"First H2O dosing: dividing volume by 10: {volume_needed:.2f} mL")
                
                dosing_time = self.convert_volume_to_dosing_time(volume_needed)
                if dosing_time >= self.config['min_dosing_time_ms']:
                    logger.info(f"Stage {stage_config['stage_number']} chemistry decision: Dilute with H2O {volume_needed:.2f} mL ({dosing_time} ms)")
                    return "ec_minus_h2o", dosing_time, volume_needed
                
            elif ec_mScm < target_ec:
                # EC too low - use multi-pump approach
                original_target = self.config['target_ec']
                self.config['target_ec'] = target_ec
                
                _, total_volume_needed = self.calculate_chemical_dosing_volume("ec_plus")
                self.config['target_ec'] = original_target
                
                # Apply safety factor
                ec_dosing_count = len([e for e in self.dosing_history if e.get('pump', '') in ['ec_plus_sola', 'ec_plus_solb', 'ec_plus_solc', 'multi_ec_plus']])
                if ec_dosing_count == 0:
                    total_volume_needed /= 10
                    logger.info(f"First EC+ dosing: dividing volume by 10: {total_volume_needed:.2f} mL")
                
                # Calculate volumes per pump based on ratios
                pump_volumes = self.calculate_multi_pump_volumes(total_volume_needed, stage_config)
                
                # Send simultaneous commands
                if any(volume > 0 for volume in pump_volumes.values()):
                    success = self.send_simultaneous_dosing_commands(pump_volumes)
                    if success:
                        logger.info(f"Stage {stage_config['stage_number']} chemistry decision: Multi-pump EC+ dosing completed")
                        return "multi_ec_plus", 0, total_volume_needed  # Special return for multi-pump
        
        # Second priority: Check if pH needs correction
        if ph_deviation > ph_tolerance:
            # Use stage-specific target for calculation
            original_target = self.config['target_ph']
            self.config['target_ph'] = target_ph  # Temporarily override
            ...
            if ph_val < target_ph:
                ...
                if ph_plus_dosing_count == 0:
                    volume_needed /= 10
                    logger.info(f"First pH+ dosing in Stage {stage_config['stage_number']}: dividing volume by 10: {volume_needed:.2f} mL")
                else:
                    volume_needed /= 1
                    logger.info(f"Subsequent pH+ dosing in Stage {stage_config['stage_number']}: dividing volume by 1: {volume_needed:.2f} mL")
                ...
                if dosing_time >= self.config['min_dosing_time_ms']:
                    self.config['target_ph'] = original_target  # Restore original
                    logger.info(f"Stage {stage_config['stage_number']} chemistry decision: Increase pH with {volume_needed:.2f} mL ({dosing_time} ms)")
                ...
                if dosing_time >= self.config['min_dosing_time_ms']:
                    self.config['target_ph'] = original_target  # Restore original
                    logger.info(f"Stage {stage_config['stage_number']} chemistry decision: Decrease pH with {volume_needed:.2f} mL ({dosing_time} ms)")
                    return "ph_minus", dosing_time, volume_needed
            
            self.config['target_ph'] = original_target  # Restore original
        
        logger.info(f"Stage {stage_config['stage_number']} chemistry decision: No dosing needed, parameters within tolerance")
        return None
    ...
    def send_dosing_command(self, pump_type, dosing_time, volume_needed):
        ...
        try:
            ...
            elif pump_type == "ec_plus_sola":
                pin = self.config['ec_plus_sola_pin']
            elif pump_type == "ec_plus_solb":
                pin = self.config['ec_plus_solb_pin']
            elif pump_type == "ec_plus_solc":
                pin = self.config['ec_plus_solc_pin']
            elif pump_type == "ec_minus_h2o":
                pin = self.config['ec_minus_h2o_pin']
            elif pump_type == "multi_ec_plus":
                # Virtual pump: dosing already completed by send_simultaneous_dosing_commands()
                logger.info(f"Multi-pump EC+ dosing already completed - registering for coefficient learning")
                return True
            else:
            ...
            if self.dashboard_socket:
                try:
                    logger.info(f"Sending command to activate {pump_type} on pin {pin} for {dosing_time}ms with volume {volume_needed:.2f} mL") # V8p4 tem "Sending command to activate..."
                    ...
                    logger.info(f"Waiting for response (timeout: {timeout}ms)") # V8p4 não tem
                    events = dict(poller.poll(timeout))
                    
                    if self.dashboard_socket in events:
                        response = self.dashboard_socket.recv_json()
                        if response.get('success'):
                            logger.info(f"Received successful response for {pump_type} activation") # V8p4 tem "Received successful response..."
                            return True
                        else:
                        ...
                        logger.info("Resetting ZMQ socket due to timeout")
                        self.setup_communication()
                        return False
                    ...
                    if "current state" in str(e).lower():
                        logger.info("Resetting ZMQ socket due to state error")
                        self.setup_communication()
                    return False
            else:
    ...
    def append_to_csv(self, pump_type, dosing_time, volume_ml=None):
        ...
        # Use passed volume if provided, otherwise calculate from dosing_time
        ...
        try:
            ...
            logger.info(f"Recorded dosing action to CSV: {pump_type}, {dosing_time}ms, {volume_ml:.2f}mL") # V8p4 tem "Recorded dosing action to CSV..."
            return True
        except Exception as e:
            logger.error(f"Failed to write to dosing history CSV: {e}")
            return False

    def calculate_multi_pump_volumes(self, total_volume, stage_config):
        """Calculate volumes for each pump based on stage ratios"""
        ratios = stage_config.get("ratio_sol_a_b_c", [1.0, 1.0, 1.0])
        total_ratio = sum(ratios)
        
        if total_ratio == 0:
            return {"ec_plus_sola": 0, "ec_plus_solb": 0, "ec_plus_solc": 0}
        
        volumes = {
            "ec_plus_sola": total_volume * (ratios[0] / total_ratio),
            "ec_plus_solb": total_volume * (ratios[1] / total_ratio), 
            "ec_plus_solc": total_volume * (ratios[2] / total_ratio)
        }
        
        logger.info(f"Volume distribution - SolA: {volumes['ec_plus_sola']:.2f}mL, SolB: {volumes['ec_plus_solb']:.2f}mL, SolC: {volumes['ec_plus_solc']:.2f}mL")
        return volumes

    def send_simultaneous_dosing_commands(self, pump_volumes):
        """Send dosing commands for multiple pumps simultaneously"""
        success_count = 0
        total_pumps = sum(1 for volume in pump_volumes.values() if volume > 0)
        
        for pump_type, volume in pump_volumes.items():
            if volume > 0:
                dosing_time = self.convert_volume_to_dosing_time(volume)
                if self.send_dosing_command(pump_type, dosing_time, volume):
                    success_count += 1
        
        return success_count == total_pumps

    def get_current_stage_config(self):
        """Get configuration for the current stage based on elapsed time"""
        if self.config["program_start_time"] is None:
            return None
                
        elapsed_hours = (time.time() - self.config["program_start_time"]) / 3600
        
        # Find the appropriate stage based on elapsed time
        for stage in range(14, 0, -1):  # Check from stage 14 down to 1
            stage_key = f"stage_{stage}"
            if (self.config.get(f"{stage_key}_enabled", False) and 
                elapsed_hours >= self.config.get(f"{stage_key}_trigger_hours", 0)):
                
                return {
                    "stage_number": stage,
                    "target_ph": self.config.get(f"{stage_key}_target_ph", self.config["target_ph"]),
                    "ph_tolerance": self.config.get(f"{stage_key}_ph_tolerance", self.config["ph_tolerance"]),
                    "target_ec": self.config.get(f"{stage_key}_target_ec", self.config["target_ec"]),
                    "ec_tolerance": self.config.get(f"{stage_key}_ec_tolerance", self.config["ec_tolerance"]),
                    "ec_continuous_monitoring": self.config.get(f"{stage_key}_ec_continuous_monitoring", True),
                    "ratio_sol_a_b_c": self.config.get(f"{stage_key}_ratio_sol_a_b_c", [1.0, 1.0, 1.0])
                }
        
        # Default to stage 1 if no stage matches
        return {
            "stage_number": 1,
            "target_ph": self.config.get("stage_1_target_ph", self.config["target_ph"]),
            "ph_tolerance": self.config.get("stage_1_ph_tolerance", self.config["ph_tolerance"]),
            "target_ec": self.config.get("stage_1_target_ec", self.config["target_ec"]),
            "ec_tolerance": self.config.get("stage_1_ec_tolerance", self.config["ec_tolerance"]),
            "ec_continuous_monitoring": self.config.get("stage_1_ec_continuous_monitoring", True),
            "ratio_sol_a_b_c": self.config.get("stage_1_ratio_sol_a_b_c", [1.0, 1.0, 1.0])
        }
    ...
    def check_stage_transition(self):
        ...
        if current_stage_config and current_stage_config["stage_number"] != self.config["current_stage"]:
            old_stage = self.config["current_stage"]
            new_stage = current_stage_config["stage_number"]
            self.config["current_stage"] = new_stage
            
            elapsed_hours = (time.time() - self.config["program_start_time"]) / 3600
            logger.info(f"STAGE TRANSITION: Stage {old_stage} → Stage {new_stage} (after {elapsed_hours:.1f} hours)")
            logger.info(f"New targets - pH: {current_stage_config['target_ph']}, EC: {current_stage_config['target_ec']} mS/cm")
    ...
    def run(self):
        ...
        while self.running:
            try:
                # Check for new event file
                if self.check_for_new_event_file():
                    logger.info(f"Switched to new event file: {self.current_event_file}. Continuing detection cycle.")

                # Clean old processed events (more than 1 hour)
                current_time = time.time()
                ...
                # Clean old unique event IDs
                old_event_ids = [event_id for event_id, data in self.event_unique_ids.items() 
                                if current_time - data.get('timestamp', 0) > 3600]  # 1 hour in seconds
                for event_id in old_event_ids:
                    del self.event_unique_ids[event_id]

                # Check if we're in calibration before proceeding
                if self.in_prgcal:
                ...
                if measurement_result:
                    ...
                    # Check minimum cycle
                    if int(cycle_id) < 1:
                        logger.info(f"Skipping cycle {cycle_id} - minimum cycle is 1")
                        time.sleep(1)
                        continue
                    
                    # The sensor data was already updated by detect_prgsample_ph_measurement()
                    logger.info("Using sensor data from event_data.csv")
                    
                    # STEP 2: Ensure we have valid sensor data
                    if not self.latest_sensor_data:
                        logger.warning("No sensor data available after measurement detection")
                        time.sleep(1)
                        continue
                    ...
                    # Explicitly log current values to ensure synchronization
                    logger.info(f"Current sensor readings: pH={current_ph:.2f}, EC={current_ec:.2f}")
                    
                    if current_ph is None or current_ec is None:
                        logger.warning("Incomplete sensor data, skipping dosing decision")
                        time.sleep(1)
                        continue
                    ...
                    # STEP 4: Check for Event #6 to proceed with dosing
                    event6_detected = self.check_for_prgsample_event2()
                    if not event6_detected:
                        # Check buffer for Event #6 in the same cycle
                        event6_detected = self.check_event_buffer_for_event6(cycle_id)
                    
                    if event6_detected:
                        # Determine which Event #6 we're using (direct detection or buffer)
                        event6_cycle_id = getattr(self, 'last_detected_event6_cycle', cycle_id)
                        event6_id = getattr(self, 'last_detected_event6_id', None)
                        
                        # Verify cycle synchronization
                        if event6_cycle_id != cycle_id:
                            logger.warning(f"Cycle mismatch: Event #5 cycle {cycle_id}, Event #6 cycle {event6_cycle_id}. Skipping dosing.")
                            time.sleep(1)
                            continue
                        
                        # Check if this event was already processed
                        if self.is_event_already_processed(cycle_id, event6_id):
                            logger.info(f"Event for cycle {cycle_id} already processed, skipping")
                            time.sleep(1)
                            continue
                        
                        logger.info(f"EVENT: PRGSample event #6 detected for cycle {cycle_id} - proceeding with dosing")
                        
                        # STEP 5: Calculate dosing volume with appropriate safety factor
                        dosing_result = self.chemistry_based_dosing_decision(measurement_type)
                        
                        if dosing_result:
                            pump_type, dosing_time, volume_needed = dosing_result
                            
                            logger.info(f"DOSING DECISION: {pump_type} for {dosing_time}ms ({volume_needed:.2f}mL)")
                            ...
                            if success:
                                # Record to CSV
                                self.append_to_csv(pump_type, dosing_time, volume_needed)
                                
                                # Store cycle information for next cycle's learning
                                ...
                                if event6_id:
                                    self.event_unique_ids[event6_id]['processed'] = True
                                
                                logger.info(f"Dosing completed successfully for cycle {cycle_id}")
                            else:
                                logger.error(f"Failed to execute dosing command for cycle {cycle_id}")
                        else:
                            logger.info("No dosing needed, parameters within tolerance")
                            # Still mark as processed to avoid reprocessing
                            self.processed_events[cycle_id] = time.time()
                            if event6_id:
                                self.event_unique_ids[event6_id]['processed'] = True
                    else:
                        logger.debug(f"Event #6 not detected yet for cycle {cycle_id}, continuing to monitor")
...
# Remove duplicate function definitions at the end of the file
# Remove these lines that are duplicated:
# def get_current_stage_config(self): ...
# def check_stage_transition(self): ...
# Remove duplicate logging configuration section
