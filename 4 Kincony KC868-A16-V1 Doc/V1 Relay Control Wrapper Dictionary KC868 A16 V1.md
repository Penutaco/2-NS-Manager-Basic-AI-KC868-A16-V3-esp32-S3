...
| Relay | GPIO Pin | I2C Addr | Bit | Physical Terminal | Function | Description |
|-------|----------|----------|-----|-------------------|----------|-------------|
...
2. **CH1-CH4**: Analog input channels (GPIO 36, 34, 35, 39)
3. **HT1-HT3**: Direct GPIO terminals (GPIO 32, 33, 14)
4. **X1-X16**: Digital input terminals (I2C controlled)
...
### GPIO Pin Changes (v2.0 Update)

**Old Configuration** (before relay wrapper):
- GPIO 4, 5 were used for LED control ❌
- GPIO 21, 22 were used for I2C ❌
- Relays controlled directly via GPIO ❌

**New Configuration** (relay wrapper):
- GPIO 4, 5 now used for I2C ✅
- GPIO 9, 10 now used for LED control ✅
- Relays controlled via I2C PCF8574 ✅
...
1. **Check I2C Connection**: Verify GPIO 4 (SDA) and GPIO 5 (SCL) wiring
2. **Test I2C Devices**: Use I2C scanner to confirm 0x24 and 0x25 addresses
3. **Verify Power**: Ensure 12V power supply is connected
